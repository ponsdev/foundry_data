...
export const Nehwon = {
    "month_len": {
        "Lover's Moon": { days: [30, 30] },
        "Snow Moon": { days: [30, 30] },
        "Wolf's Moon": { days: [30, 30] },
        "Seed Moon": { days: [30, 30] },
        "White Witches' Moon": { days: [30, 30] },
        "Ghost Moon": { days: [30, 30] },
        "Murderer's Moon": { days: [30, 30] },
        "Thunder Moon": { days: [30, 30] },
        "Satyr's Moon": { days: [30, 30] },
        "Harvest Moon": { days: [30, 30] },
        "Black Witches' Moon": { days: [30, 30] },
        "Frost Moon": { days: [30, 30] },
    },
    "leap_year_rule": "(year) => 0",
    "weekdays": [
        "Hare",
    ...
    "has_year_0": true,
    "yearNames": [
        "Year of the Feathered Death",
        "Year of the Basilisk",
        "Year of the Horde",
        "Year of the Leviathan",
        "Year of the Roc",
        "Year of the Dragon",
...
export const DarkSun = {
    "month_len": {
        "Scorch": { days: [30, 30] },
        "Morrow": { days: [30, 30] },
        "Rest": { days: [30, 30] },
        "Gather": { days: [30, 30] },
        "1 Day Festival of the Cooling Sun": { days: [1, 1], intercalary: true },
        "2 Day Festival of the Cooling Sun": { days: [1, 1], intercalary: true },
        "3 Day Festival of the Cooling Sun": { days: [1, 1], intercalary: true },
        "4 Day Festival of the Cooling Sun": { days: [1, 1], intercalary: true },
        "5 Day Festival of the Cooling Sun": { days: [1, 1], intercalary: true },
        "Breeze": { days: [30, 30] },
        "Mist": { days: [30, 30] },
        "Bloom": { days: [30, 30] },
        "Haze": { days: [30, 30] },
        "1 Day Festival of the Soaring Sun": { days: [1, 1], intercalary: true },
        "2 Day Festival of the Soaring Sun": { days: [1, 1], intercalary: true },
        "3 Day Festival of the Soaring Sun": { days: [1, 1], intercalary: true },
        "4 Day Festival of the Soaring Sun": { days: [1, 1], intercalary: true },
        "5 Day Festival of the Soaring Sun": { days: [1, 1], intercalary: true },
        "Hoard": { days: [30, 30] },
        "Wind": { days: [30, 30] },
        "Sorrow": { days: [30, 30] },
        "Smolder": { days: [30, 30] },
        "1 Day Festival of the Highest Sun": { days: [1, 1], intercalary: true },
        "2 Day Festival of the Highest Sun": { days: [1, 1], intercalary: true },
        "3 Day Festival of the Highest Sun": { days: [1, 1], intercalary: true },
        "4 Day Festival of the Highest Sun": { days: [1, 1], intercalary: true },
        "5 Day Festival of the Highest Sun": { days: [1, 1], intercalary: true },
    },
    "leap_year_rule": "(year) => 0",
    "weekdays": ["1 Day", "2 Day", "3 Day", "4 Day", "5 Day", "6 Day"],
    "clock_start_year": 0,
    "first_day": 0,
    "notes": {},
    "hours_per_day": 24,
...
export class DTCalc {
    ...
    static createFromData(calendarSpec = calendars[Object.keys(calendars)[game.settings.get("about-time", "calendar")]]) {
        ...
        if (calendarSpec.yearNames) {
            DTCalc.hasYearNames = true;
            DTCalc.yearNames = duplicate(calendarSpec.yearNames);
        }
        else {
            DTCalc.hasYearNames = false;
            DTCalc.yearNames = undefined;
        }
        DTCalc.namedYears = calendarSpec.namedYears ? duplicate(calendarSpec.namedYears) : {};
    }
    /**
     *
