import { i18n, isStringEquals, is_real_number } from "../lib/lib.js";
/**
 * Data class for defining an effect
 */
export default class Effect {
    // END ADDED FROM 4535992
    constructor({ customId = '', name = '', description = '', icon = '', tint = '', seconds = NaN, rounds = NaN, turns = NaN, isDynamic = false, isViewable = true, isDisabled = false, isTemporary = false, isSuppressed = false, flags = {}, changes = [], atlChanges = [], tokenMagicChanges = [], nestedEffects = [], transfer = false, atcvChanges = [], dae = {}, overlay = false, }) {
