...
function init() {
    ...
    Hooks.on("renderDLCharacterSheet", (app) => getSetting(ModuleSetting.FILTERS_SHEETS_ENABLED) &&
        demonlordRenderHook(app, "character"));
    Hooks.on("renderDLCreatureSheet", (app) => getSetting(ModuleSetting.FILTERS_SHEETS_ENABLED) &&
